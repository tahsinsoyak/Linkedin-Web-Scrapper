...
def getProfileURLs(name, city, job, language, skill):
    ...
    driver.get(f"https://www.linkedin.com/search/results/people/?keywords={name}%20{job}%20{city}%20{language}%20{skill}&origin=CLUSTER_EXPANSION&sid=se&page={page_num}")
    time.sleep(3)
    time.sleep(3)
...
def returnProfileInfo(employeeLink, companyName):
    ...
    morebtn.click()
    time.sleep(1)
    savepdf = driver.find_element(by=By.XPATH,value="//body/div[5]/div[3]/div[1]/div[1]/div[2]/div[1]/div[1]/main[1]/section[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/ul[1]/li[2]/div[1]/span[1]")
    time.sleep(2)
    savepdf.click()
    time.sleep(2)
